...
<#
  XIAN one-post-per-day (2026-09-17 retro archive). Folder export per XIAN-ARCHIVE-HARD-RULES.md.
  Labels: P1-Roadmap, documentation

  $env:GH_TOKEN = "ghp_..."
  powershell -ExecutionPolicy Bypass -File .\scripts\publish_xian_daily_issue_2026_09_17.ps1
#>
param(
    [string] $Token,
...
$titlePath = Join-Path $root "docs\issue-exports\xian-daily-2026-09-17\title.txt"
$bodyPath = Join-Path $root "docs\issue-exports\xian-daily-2026-09-17\body.md"
...
$headers = @{
    ...
    "User-Agent"           = "HCL-publish-xian-daily-20260917-ps1"
}
...
if ($WhatIf) {
    Write-Host "WhatIf: POST issue (2026-09-17 XIAN daily folder export)"
    exit 0
}
