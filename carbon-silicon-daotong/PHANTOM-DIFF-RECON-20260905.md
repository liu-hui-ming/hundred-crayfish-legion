...
## 2. 对账结果（2026-09-05 基线 · 2026-09-07 复核）

| 文件 | README MD5 (SSOT) | 本地状态 | 说明 |
|------|-------------------|----------|------|
| Ch0–Ch5 正文 | 见 README 块 | ❌ MISMATCH | 正文迭代后指纹块未同步 |
| CH0-CH5进度台账 | `804907ea…dcaa` | ❌ MISMATCH | 台账已更新 |
...
- 全文指纹块：**待下一 SSOT 指纹同步 commit**（7/7 仍 MISMATCH，属已知存量）
- 生产 OpenClaw：**未写入**
